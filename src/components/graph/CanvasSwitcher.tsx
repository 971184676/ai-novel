...
export function CanvasSwitcher({
  ...
  return (
    <div className="absolute top-3 left-1/2 -translate-x-1/2 z-30 flex items-center gap-1 bg-bg border-2 border-text shadow-game p-1 max-w-[70vw] overflow-x-auto">
