    ...
    <div className="flex h-screen min-h-screen bg-bg text-text">
      ...
      <div
        className={`
          ...
          lg:fixed lg:inset-y-0 lg:left-0 lg:transform-none lg:z-auto
      ...
      <div className="flex-1 min-w-0 min-h-0 flex flex-col h-full lg:ml-[240px]">
        {/* Mobile header */}
        ...
        <main className="flex-1 min-w-0 min-h-0 h-full px-4 py-6 lg:px-12 lg:py-10 flex flex-col overflow-y-auto">
          <Outlet />
        </main>
      </div>
    </div>
